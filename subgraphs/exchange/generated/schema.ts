...
export class GlideFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save GlideFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save GlideFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("GlideFactory", id.toString(), this);
  }

  static load(id: string): GlideFactory | null {
    return store.get("GlideFactory", id) as GlideFactory | null;
  }
  ...
  get totalVolumeELA(): BigDecimal {
    let value = this.get("totalVolumeELA");
    return value.toBigDecimal();
  }

  set totalVolumeELA(value: BigDecimal) {
    this.set("totalVolumeELA", Value.fromBigDecimal(value));
  }
  ...
  get totalLiquidityELA(): BigDecimal {
    let value = this.get("totalLiquidityELA");
    return value.toBigDecimal();
  }

  set totalLiquidityELA(value: BigDecimal) {
    this.set("totalLiquidityELA", Value.fromBigDecimal(value));
  }
}
...
export class Bundle extends Entity {
  ...
  get elaPrice(): BigDecimal {
    let value = this.get("elaPrice");
    return value.toBigDecimal();
  }

  set elaPrice(value: BigDecimal) {
    this.set("elaPrice", Value.fromBigDecimal(value));
  }
}
...
export class Token extends Entity {
  ...
  get derivedELA(): BigDecimal | null {
    let value = this.get("derivedELA");
  ...
  set derivedELA(value: BigDecimal | null) {
    if (value === null) {
      this.unset("derivedELA");
    } else {
      this.set("derivedELA", Value.fromBigDecimal(value as BigDecimal));
    }
  }
...
export class Pair extends Entity {
  ...
  get reserveELA(): BigDecimal {
    let value = this.get("reserveELA");
    return value.toBigDecimal();
  }

  set reserveELA(value: BigDecimal) {
    this.set("reserveELA", Value.fromBigDecimal(value));
  }
  ...
  get trackedReserveELA(): BigDecimal {
    let value = this.get("trackedReserveELA");
    return value.toBigDecimal();
  }

  set trackedReserveELA(value: BigDecimal) {
    this.set("trackedReserveELA", Value.fromBigDecimal(value));
  }
...
export class GlideDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save GlideDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save GlideDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("GlideDayData", id.toString(), this);
  }

  static load(id: string): GlideDayData | null {
    return store.get("GlideDayData", id) as GlideDayData | null;
  }
  ...
  get dailyVolumeELA(): BigDecimal {
    let value = this.get("dailyVolumeELA");
    return value.toBigDecimal();
  }

  set dailyVolumeELA(value: BigDecimal) {
    this.set("dailyVolumeELA", Value.fromBigDecimal(value));
  }
